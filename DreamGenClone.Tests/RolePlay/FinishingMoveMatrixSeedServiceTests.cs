...
public sealed class FinishingMoveMatrixSeedServiceTests : IDisposable
{
    ...
    public async Task SeedDefaultsAsync_WhenEmpty_InsertsExampleMatrixRows()
    {
        ...
        Assert.Contains(rows, r => r.DesireBand == "75-100" && r.SelfRespectBand == "60-100" && r.DominanceBand == "Low");
        Assert.Contains(rows, r => r.DesireBand == "0-49" && r.SelfRespectBand == "0-29" && r.DominanceBand == "High");
    }
