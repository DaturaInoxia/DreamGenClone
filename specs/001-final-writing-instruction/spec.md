...
- **FR-001**: The Final Instruction slot (Slot 17) MUST contain Theme Contract, Scene Guidance, Scene Direction, and Action directives in a consolidated block at the end of the prompt (recency placement). Style Guide components (Prose Style, Voice, Tone, Focus, Heat Level, POV, Immersion, Word Target) live in Slot 8 (primacy placement) — NOT duplicated in Slot 17.
- **FR-002**: Slot 15 (IntensityPacing) MUST NOT emit any writing direction text after consolidation — only structural data such as available positions. Slot 8 (WritingStyle) remains the authoritative primacy location for Style Guide content.
...
- **FR-014**: No writing direction content MUST be duplicated between Slots 12, 15, and 17. Style Guide content (Prose Style, Voice, Tone, Focus, Heat Level, POV, Immersion, Word Target) lives in Slot 8 (primacy). Operational/scene content (Theme Contract, Scene Guidance, Scene Direction, Action) lives in Slot 17 (recency). These are different content types — NOT duplicated.
...
- **SC-002**: Writing direction for a turn is placed at two attention points: Style Guide (Prose Style, Voice, Tone, Heat Level, Focus, POV, Immersion, Word Target) in Slot 8 for primacy; operational directives (Theme Contract, Scene Guidance, Scene Direction, Action) in Slot 17 for recency. No content is scattered across Slots 12 or 15.
