...
| B-006 | Ensure sex scenes are more detailed and explicit | `implemented` | Prompt framing and continuation guidance for climax-phase scenes needs to direct more explicit and descriptive output. Plan: `specs/006-explicit-scene-writing/plan.md`. Implemented: static prompt improvements (US1/US2) + configurable SceneDirective per intensity profile (US3). 37 unit tests passing. |
