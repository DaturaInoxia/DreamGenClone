...
- Begin application infrastructure against configured topology-independent HTTP/model contracts
  while the compiler corpus is frozen, run, and scored independently.
