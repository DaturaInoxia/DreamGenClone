...
`specs/Planning/B-032-scene-image-generator/controlnet-touch-proof.md`
...
1. `specs/Planning/B-032-scene-image-generator/continuity-rendering-architecture.md`
2. `specs/Planning/B-032-scene-image-generator/controlnet-touch-proof.md` once created
3. `specs/Planning/B-032-scene-image-generator/RESUME-HANDOFF-pony-builder.md`
