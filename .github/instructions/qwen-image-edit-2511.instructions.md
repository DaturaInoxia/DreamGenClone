...
- Canonical reproducible proof: `specs/Planning/B-032-scene-image-generator/phase-2-character-identity/qwen-simple-people-proof/`.
...
- Adult-content editing is **not tested**. Never claim Qwen adult-content capability from this proof.
...
- Read `specs/Planning/B-032-scene-image-generator/phase-2-character-identity/qwen-simple-people-proof/RUNBOOK.md` before running or changing the harness.
...
- Generated replay outputs belong under ignored `artifacts/tmp/`; only the canonical proof images and metadata under `specs/.../qwen-simple-people-proof/` are source controlled.