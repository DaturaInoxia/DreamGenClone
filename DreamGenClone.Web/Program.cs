...
builder.Services.AddScoped<IBackgroundJobHandler>(serviceProvider => serviceProvider.GetRequiredService<SceneImageEditingJobHandler>());
...
builder.Services.AddSingleton<IImageEditorEndpointReadiness, ImageEditorEndpointReadiness>();
...
builder.Services.AddScoped<ISceneImageProductionSessionGuard, SceneImageProductionSessionGuard>();
...
builder.Services.AddSingleton<IProductionMediaCompiler, PonyProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompiler, SdxlProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompiler, Flux2GenerationProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompiler, Flux2EditProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompiler, QwenImage2512ProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompiler, QwenImageEdit2511ProductionMediaCompiler>();
builder.Services.AddSingleton<IProductionMediaCompilerRegistry, ProductionMediaCompilerRegistry>();
builder.Services.AddScoped<IProductionMediaCompilationService, ProductionMediaCompilationService>();
builder.Services.AddScoped<ICharacterAssetGenerationService, CharacterAssetGenerationService>();
builder.Services.AddSingleton<IProductionDispatchAdapter, RunPodProductionDispatchAdapter>();
builder.Services.AddSingleton<IProductionDispatchAdapter, TogetherProductionDispatchAdapter>();
builder.Services.AddSingleton<IProductionDispatchAdapterRegistry, ProductionDispatchAdapterRegistry>();
builder.Services.AddScoped<IProductionReconciliationService, ProductionReconciliationService>();
builder.Services.AddScoped<IProductionWorkloadService, ProductionWorkloadService>();
