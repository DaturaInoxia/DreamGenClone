...
public sealed class SceneImageBeatAnalysisService
{
        ...
        IReadOnlyList<Character>? characters)
    {
        ...
        system.AppendLine("A beat may have one or many active characters and zero or many observers. Include every character actively involved in or observing that moment.");
