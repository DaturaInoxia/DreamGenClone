...
public sealed class DecisionOption
{
    ...
    public string BehaviorStyleHint { get; set; } = string.Empty;
    public string CharacterDirectionInstruction { get; set; } = string.Empty;
    public string ChatInstruction { get; set; } = string.Empty;
